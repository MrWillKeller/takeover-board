...
rounded to 3 significant figures, so the denominator is coarse for large games. Note the pool is
already floored at 100 CCU upstream, so every game listed here clears that bar.</div>
<div class="tools">
  <input type="text" id="q" placeholder="filter by game or developer&hellip;">
  <select id="minccu">
    <option value="0" selected>any CCU</option>
    <option value="500">CCU &ge; 500</option><option value="1000">CCU &ge; 1,000</option>
    <option value="5000">CCU &ge; 5,000</option><option value="10000">CCU &ge; 10,000</option>
  </select>
</div>
